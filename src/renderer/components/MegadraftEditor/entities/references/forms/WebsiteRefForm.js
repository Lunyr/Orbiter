/***
 * form for inputting website references
 * @craiglu
 */
...
export default class WebsiteRefForm extends React.Component {
  submit = event => {
      ...
      <form className={css(styles.formContainer)} onSubmit={this.submit}>
        <div className={css(styles.formFieldsContainer)}>
          <div className={css(styles.leftColumn)}>
            ...
            <div className={css(styles.inputContainer)}>
              <span className={css(styles.inputLabel)}>Website*</span>
              <input
                className={css(styles.input)}
                onClick={this.props.focus}
                onChange={this.props.onWebsiteChange}
                value={this.props.reference.website}
                required
              />
            </div>
          </div>
          <div className={css(styles.rightColumn)}>
            ...
            <div className={css(styles.inputContainer)}>
              <span className={css(styles.inputLabel)}>Last Accessed</span>
              <input
                className={css(styles.input)}
                onClick={this.props.focus}
                onChange={this.props.onLastAccessedChange}
                value={this.props.reference.lastAccessed}
              />
            </div>
          </div>
        </div>
        <div className={css(styles.submissionContainer)}>
          ...
          <button type="submit" className={css(styles.save)}>
            Save
          </button>
        </div>
      </form>
